...
public class AppUtils {
  ...
  //  public static String serviceAPIURL = "http://192.168.2.120:654/Service.asmx/";
    public static String serviceAPIURL = "http://swma.versatileitsolution.com/WebService/Service.asmx/";
    public static String imageURL = "http://swma.versatileitsolution.com/webservice/";
    public static String circluerURL = "http://swma.versatileitsolution.com/admin/";
    ...
    public static String circluerURL() {
        return (circluerURL);
    }
    ...
    public static void dismissProgressDialog() {
        try {
            if (!cust_dialog.equals(null)) {
                cust_dialog.dismiss();
                Log.d("cust_dialog", "dismissProgressDialog completed");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//                        intent.putExtra("SendToHome",true);
          ...
          txt_cancel.setTextColor(con.getResources().getColor(R.color.color_666666));
