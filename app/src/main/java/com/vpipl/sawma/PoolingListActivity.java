...
import com.vpipl.sawma.Adapter.Pooling_list_Adapter;
...
public class PoolingListActivity extends Activity {
    private String TAG = "PoolingListActivity";
    ...
    public Pooling_list_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(R.layout.activity_pooling_list);

            act = PoolingListActivity.this;
    ...
    private void executePoolingListRequest() {
        try {
            if (AppUtils.isNetworkAvailable(act)) {
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(act, postParameters, QueryUtils.methodToView_PoolingByUser, TAG);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return response;
    ...
    private void getAllActivityListResult(JSONArray jsonArray) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                map.put("PoolingID", jsonObject.getString("PoolingID"));
                map.put("PoolingTitle", jsonObject.getString("PoolingTitle"));
                map.put("PoolingStatus", jsonObject.getString("PoolingStatus"));
    ...
    private void showListView() {
        try {
            if (array_list.size() > 0) {
                adapter = new Pooling_list_Adapter(act, array_list);
