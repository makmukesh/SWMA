...
public class Meeting_list_Adapter extends RecyclerView.Adapter<Meeting_list_Adapter.MyViewHolder> {
    public ArrayList<HashMap<String, String>> array_List;
    LayoutInflater inflater = null;
    Context context;

    public Meeting_list_Adapter(Context con, ArrayList<HashMap<String, String>> list) {
        array_List = list;
