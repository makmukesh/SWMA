...
public class Recent_Meeting_Adapter extends RecyclerView.Adapter<Recent_Meeting_Adapter.MyViewHolder> {
    public ArrayList<HashMap<String, String>> array_List;
    LayoutInflater inflater = null;
    Context context;

    public Recent_Meeting_Adapter(Context con, ArrayList<HashMap<String, String>> list) {
        array_List = list;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        try {
            ...
            holder.txt_lead_first_letter.setAllCaps(true);
