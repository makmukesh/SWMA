...
public class NotificationActivity extends Activity {
    private String TAG = "NotificationHistoryActivity";
    ...
    public Notification_History_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (AppUtils.isNetworkAvailable(act)) {
                executeNotificationHistoryRequest();
            } else {
    ...
    private void executeNotificationHistoryRequest() {
        try {
            if (AppUtils.isNetworkAvailable(act)) {
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(act, postParameters, QueryUtils.methodToSelect_Notifiction, TAG);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return response;
    ...
    private void getAllActivityListResult(JSONArray jsonArray) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                map.put("Title", jsonObject.getString("NotiTitle"));
                map.put("Desc", jsonObject.getString("NotiDescri"));
    ...
    private void showListView() {
        try {
            if (array_list.size() > 0) {
                adapter = new Notification_History_Adapter(act, array_list);
